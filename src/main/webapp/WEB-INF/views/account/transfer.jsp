...
<br>
<label>받는사람의 계좌번호를 입력하세요</label><input type="text" name="account_number" id="account_number">
<br>
<label>이체할 금액을 입력하세요</label><input type="text" name="money" id="money">
<br>
<input type="hidden" name="member_id" value="${member.id}">
<br>
<button type="submit">이체 하기</button>
<br>
