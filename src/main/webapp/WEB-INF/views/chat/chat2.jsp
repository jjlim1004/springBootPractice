...
<body>
	<div class="chat_window">
		...
		<div id="yourName">
			<div class="bottom_wrapper clearfix">
				<div class="message_input_wrapper">
					<input class="message_input" type="text" name="userName"
						id="userName" placeholder="Type your ID here...">
				</div>
				<div class="send_message">
					<div class="icon"></div>
					<div class="text">
						<button onclick="chatName()" id="startBtn">Next</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="yourMsg">
			<div class="bottom_wrapper clearfix">
				<div class="message_input_wrapper">
					<input class="message_input" id="chatting"
